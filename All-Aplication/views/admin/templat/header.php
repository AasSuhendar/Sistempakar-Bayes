      ...
      <div class="navbar navbar-fixed-top scroll-hide">
        ...
        <div class="container-fluid main-nav clearfix">
          <div class="nav-collapse">
            <ul class="nav">
              <li>
                <a href="<?= base_url();?>admin"><span aria-hidden="true" class="se7en-home"></span>Dashboard</a>
              </li>
              <li><a class="current" href="<?= base_url();?>admin/diagnosa">
                <span aria-hidden="true" class="se7en-feed"></span>Master Diagnosa</a>
              </li>
             <li><a class="current" href="<?= base_url();?>rule">
                <span aria-hidden="true" class="se7en-feed"></span>Master Rule</a>
              </li>
			  <li><a class="current" href="<?= base_url();?>admin/saran">
                <span aria-hidden="true" class="se7en-feed"></span>Kritik Dan Saran</a>
              </li>
			   <li><a class="current" href="<?= base_url();?>admin/pasien">
                <span aria-hidden="true" class="se7en-feed"></span>Log Pasien</a>
              </li>
